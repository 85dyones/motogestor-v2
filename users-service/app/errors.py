...
class UnauthorizedError(ApiError):
    def __init__(
        self, message: str = "Não autorizado", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(
...
class ForbiddenError(ApiError):
    def __init__(
        self, message: str = "Acesso negado", details: Optional[Dict[str, Any]] = None
    ):
        super().__init__(
...
class NotFoundError(ApiError):
    def __init__(
        ...
        super().__init__(
            message=message, status_code=404, code="not_found", details=details
        )
...
class ConflictError(ApiError):
    def __init__(
        ...
        super().__init__(
            message=message, status_code=409, code="conflict", details=details
        )
